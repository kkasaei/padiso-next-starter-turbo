...
type BrandTrackingBreadcrumbsProps = {
    brandId: string
}

export default function BrandTrackingBreadcrumbs({ brandId }: BrandTrackingBreadcrumbsProps) {
    ...
    return (
         <div className="flex flex-row items-center justify-between gap-2">
            ...
            <Link
                href={`/dashboard/brands/${brandId}/tracking?tab=prompts`}
