...
export function SuggestionsSheet({
  ...
  // ============================================================
  // Mock Data - PADISO.co focused suggestions
  // ============================================================
  const mockSuggestions: SuggestionItem[] = [
    {
      id: 'sug-1',
      title: 'Sustainable Fashion Brands',
      prompt: 'What are the best sustainable fashion accessory brands to shop from in 2025?',
      category: 'comparison',
      isUsed: false,
    },
    {
      id: 'sug-2',
      title: 'Eco-Friendly Handbag Guide',
      prompt: 'How do I find high-quality eco-friendly handbags that are also stylish?',
      category: 'how-to',
      isUsed: false,
    },
    {
      id: 'sug-3',
      title: 'PADISO Brand Review',
      prompt: 'What do customers say about PADISO accessories and is the quality worth the price?',
      category: 'buying-intent',
      isUsed: false,
    },
    {
      id: 'sug-4',
      title: 'Designer Bag Alternatives',
      prompt: 'What are the best affordable alternatives to luxury designer bags?',
      category: 'comparison',
      isUsed: false,
    },
    {
      id: 'sug-5',
      title: 'Minimalist Accessory Styling',
      prompt: 'How should I style minimalist accessories for both work and casual occasions?',
      category: 'how-to',
      isUsed: false,
    },
  ]
  ...
  const handleGenerate = () => {
    ...
    // Simulate generating new suggestions - PADISO.co focused
    setTimeout(() => {
      const newSuggestions: SuggestionItem[] = [
        {
          id: `sug-${Date.now()}-1`,
          title: 'Capsule Wardrobe Accessories',
          prompt: 'What essential accessories should I have for a minimalist capsule wardrobe?',
          category: 'how-to',
          isUsed: false,
        },
        {
          id: `sug-${Date.now()}-2`,
          title: 'Local Sustainable Fashion',
          prompt: 'Where can I find sustainable fashion brands that ship to my area?',
          category: 'local',
          isUsed: false,
        },
        {
          id: `sug-${Date.now()}-3`,
          title: 'Vegan Leather Quality',
          prompt: 'Are vegan leather bags as durable as real leather? What brands are best?',
          category: 'buying-intent',
          isUsed: false,
        },
      ]
