...
import { SiteDiscoverySection, ContextFilesSection } from '@/components/projects/create-project'
...
export default function Page() {
  ...
  // ============================================================
  const projectContext = useProjectContext(formData)
  ...
  const handleGenerateDescription = () => {
    const input = projectContext.getDescriptionInput()
  ...
  const handleGenerateTargeting = () => {
    const input = projectContext.getTargetingInput()
  ...
  const handleGenerateAIGuidelines = () => {
    const input = projectContext.getGuidelinesInput()
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-y-6">
                <div className="dark:divide-polar-700 flex flex-col divide-y">
                  <ProjectInformationSection
                    ...
                    canGenerate={projectContext.context.canGenerateDescription}
                  />
                </div>
              </form>
            </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-y-6">
                <div className="dark:divide-polar-700 flex flex-col divide-y">
                  ...
                  <TargetingTrackingSection
                    ...
                    canGenerate={projectContext.context.canGenerateTargeting}
                  />
                </div>
              </form>
            </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-y-6">
                <div className="dark:divide-polar-700 flex flex-col divide-y">
                  <AIGuidelinesSection
                    ...
                    canGenerate={projectContext.context.canGenerateGuidelines}
                  />
                </div>
              </form>
            </div>
