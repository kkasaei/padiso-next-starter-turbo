...
import { Plus, SquareCheckBigIcon, type LucideIcon } from "lucide-react";
...
/**
 * TasksEmptyState Component
 * 
 * A reusable empty state card for task pages.
 * Displays a centered card with an icon, title, description, and action button.
 * 
 * @component
 */
export function TasksEmptyState({
  icon: Icon = SquareCheckBigIcon,
  title = "No tasks yet",
  description,
    ...
    <div className="flex flex-1 flex-col min-w-0 p-6">
      <div className="md:dark:bg-polar-900 dark:border-polar-700 w-full md:rounded-xl md:border md:border-gray-100 md:bg-gray-50 md:p-8 lg:rounded-4xl items-center justify-center gap-y-6 md:flex md:flex-col md:py-48">
        ...
        <div className="flex flex-col items-center gap-y-6">
          ...
          <Button onClick={onCreateTask} className="rounded-2xl gap-2">
