...
import { DocsSearch } from '@/components/modules/marketing/docs/docs-search';
import { DOCS_LINKS } from '@/components/modules/marketing/marketing-links';
                ...
                item.href ? (
                  <Link
                    ...
                    className={cn(
                      ...
                      pathname === getPathname(item.href, baseURL)
