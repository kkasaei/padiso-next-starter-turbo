...
import { ExternalLink } from '@/components/modules/fragments/external-link';
import { MENU_LINKS } from '@/components/modules/marketing/marketing-links';
import { MobileMenu } from '@/components/modules/marketing/mobile-menu';
