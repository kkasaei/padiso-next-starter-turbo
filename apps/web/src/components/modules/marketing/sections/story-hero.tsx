    ...
    <GridSection hideVerticalGridLines>
      <div className="container py-24 md:py-32">
        <SiteHeading
          ...
          description="Born from our own SEO struggles, SearchFIT.AI combines intelligent tracking, AI-powered content creation, and comprehensive website audits to help you dominate the new age of AI-driven search."
        />
      </div>
    </GridSection>
  );
